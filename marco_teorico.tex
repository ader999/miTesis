...
En su trabajo de culminación \cite{gutierrez2021manejo} nos dice que los maestros del Escolar Público Salomón Ibarra Mayorga tienen conocimientos sobre las Tic y que utilizan programas de software como los navegadores chrome, edge y programas de la paquetería offise ha si como herramientas de investigación y de estudio también nos dice que estos maestros consideran de vital importancia la incorporación de las Tic en la educación también nos hablan de que la directora de este centro de estudio utiliza herramientas extras como E-books(Libros digitales), zoom y que reconoce la diferencia entre sofware y haware.También se puede observar un limite o una barrera que hay al momento de incorporar las Tic en la educación en el centro y es que el centro solo cuenta con una computadora y una impresora que solo utilizan la directora y la secretaria para la elaboración de informes los docentes no cuentan con equipos necesarios lo que les impide una mayor inmersión en las Tic.

En Nicaragua se an promovido leyes a favor dela incorporación de la tecnología en la educación "Ley General de Educación de 2006 modificada en el 2014, menciona que es objetivo de la Educación Básica el «desarrollar aprendizajes en los campos de las ciencias, las humanidades, la técnica, la cultura, el arte, la educación física y los deportes, así como aquellos que permitan el educando un buen uso y usufructo de las nuevas tecnologías»." \textcite{unesco2023nicaragua}

Otras medidas que ha incorporado Nicaragua en llevar las Tic ala educación ha sido mediante políticas "El Plan Nacional de Educación 2017-2021 incluye el uso de tecnologías educativas de información y comunicación para mejorar el aprendizaje y propone «la implementación del currículo actualizado, incluirá el uso de diferentes recursos tecnológicos de comunicación e información, así como la programación con fines educativos, para lo cual se organizará la formación de docentes». Adicionalmente incluye en las rutas educativas, «el promover el acceso y dominio de las tecnologías como herramientas para incentivar la innovación educativa, creatividad y curiosidad científica, a través del equipamiento de aulas de tecnologías, conectividad y el uso de software educativo y la capacitación y motivación de Estudiantes y docentes.»" \textcite{unesco2023nicaragua}

Otras medidas existentes implementadas en el 2022 al 2026 ha sido El plan nacional de lucha contra la pobreza y para el desarrollo humano que propone "impulsar el conocimiento y uso de la digitalización con todos(as) y para todos (as). El Programa Nacional de Desarrollo Humano 2018-2021 propone el establecimiento y desarrollo de la política de tecnologías de información y comunicación y el «fomento del buen uso de la tecnología educativa, para la creatividad, la innovación y el emprendimiento». Adicionalmente incluyó fomentar el conocimiento, uso y aprovechamiento de las diferentes tecnologías, aplicada al involucramiento de la juventud en los diversos ámbitos del desarrollo del país." \textcite{unesco2023nicaragua}
