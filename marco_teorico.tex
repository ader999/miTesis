...
Propuesta por \textcite{young1993}. Internet responde a las premisas del conocimiento situado en dos de sus características: realismo y complejidad. La Web posibilita la comunicación, el intercambio e interacción entre los usuarios que comparten afinidades de intereses.
...
\subsection{Inteligencia Artificial Generativa en la Educación}

La Inteligencia Artificial Generativa (IAG) representa un cambio de paradigma en la tecnología educativa, evolucionando de herramientas que simplemente procesan información a sistemas capaces de crear contenido nuevo y original. En el contexto de la educación superior, la IAG se define como una tecnología que utiliza modelos de aprendizaje profundo para generar texto, código, imágenes y otros formatos multimedia en respuesta a instrucciones o "prompts" del usuario \parencite{unesco2023ia}.

\subsubsection{Aplicaciones en la Planificación y Gestión Docente}

A diferencia de las TIC tradicionales que sirven como soporte para la transmisión de información, la IAG actúa como un "asistente cognitivo" para el docente. \textcite{baidoo2023education} destacan que herramientas como ChatGPT pueden asistir significativamente en la elaboración de planes de estudio, diseño de sílabos y creación de materiales didácticos, reduciendo la carga administrativa y permitiendo a los profesores centrarse en aspectos pedagógicos más complejos.

La capacidad de estos sistemas para analizar grandes volúmenes de datos y generar estructuras coherentes permite una personalización del aprendizaje sin precedentes. En la planificación curricular, la IAG puede sugerir objetivos de aprendizaje, bibliografía actualizada y estrategias de evaluación alineadas con competencias específicas, actuando como un catalizador para la creatividad docente más que como un sustituto \parencite{grassini2023shaping}.

\subsubsection{Desafíos y Consideraciones Éticas}

A pesar de sus beneficios, la integración de la IAG en la educación plantea desafíos significativos. La UNESCO \parencite{unesco2023ia} advierte sobre la necesidad de una supervisión humana rigurosa ("human-in-the-loop") para validar la precisión y pertinencia del contenido generado, dado el riesgo de "alucinaciones" (información falsa o inexacta) y sesgos inherentes a los datos de entrenamiento.

Además, existe una preocupación sobre la integridad académica y la dependencia tecnológica. Sin embargo, autores como \textcite{grassini2023shaping} argumentan que, en lugar de prohibir estas herramientas, las instituciones deben fomentar una "alfabetización en IA", capacitando a docentes y estudiantes para utilizar estas tecnologías de manera crítica y ética como complementos para potenciar el pensamiento humano.

\subsection{Modelo de Aceptación Tecnológica (TAM)}

Para comprender la adopción de nuevas herramientas tecnológicas como PLANEAUML por parte de los docentes, es fundamental recurrir a marcos teóricos consolidados. El Modelo de Aceptación Tecnológica (TAM), propuesto originalmente por \textcite{davis1989perceived}, es uno de los modelos más influyentes para explicar la intención de los usuarios de utilizar un sistema de información.

El TAM postula que la aceptación de una tecnología está determinada principalmente por dos variables cognitivas:
\begin{itemize}
    \item \textbf{Utilidad Percibida (PU):} El grado en que una persona cree que usar un sistema específico mejorará su rendimiento laboral.
    \item \textbf{Facilidad de Uso Percibida (PEOU):} El grado en que una persona cree que el uso de un sistema estará libre de esfuerzo.
\end{itemize}

Según este modelo, si los docentes perciben que el sistema mejora su eficiencia (ahorrando tiempo en la planificación) y es fácil de aprender, desarrollarán una actitud positiva hacia su uso, lo que conducirá a una mayor intención conductual y, finalmente, al uso efectivo del sistema.

\subsubsection{TAM en el Contexto Educativo Actual}

Investigaciones recientes han validado la vigencia del TAM en entornos educativos modernos. \textcite{granic2019technology}, en una revisión sistemática, concluyen que el TAM sigue siendo un modelo robusto para predecir la aceptación de tecnologías de aprendizaje, aunque sugieren que debe complementarse con factores externos como el soporte institucional y la autoeficacia computacional.

Por su parte, estudios como el de \textcite{alfadda2021measuring} han demostrado que, en el contexto de la educación post-pandemia, la facilidad de uso es un predictor crítico, ya que los docentes a menudo enfrentan ansiedad tecnológica ante herramientas complejas. Esto refuerza la importancia de diseñar interfaces intuitivas, como se propone en este trabajo de investigación.

\subsection{Tecnología educativa en Nicaragua}

En el contexto nacional, \textcite{gutierrez2021manejo} en su trabajo de culminación, señalan que los docentes del Centro Escolar Público Salomón Ibarra Mayorga poseen conocimientos sobre las TIC y utilizan software como navegadores web (Chrome, Edge) y la paquetería de Office como herramientas de investigación y estudio. Asimismo, los autores indican que los docentes consideran de vital importancia la incorporación de las TIC en la educación. Por otro lado, se destaca que la dirección del centro utiliza herramientas adicionales como libros digitales (E-books) y Zoom, reconociendo la diferencia entre software y hardware. Sin embargo, se identifica una barrera significativa para la incorporación plena de las TIC: la limitación de recursos tecnológicos, ya que el centro dispone únicamente de una computadora y una impresora destinadas al uso administrativo, lo que impide a los docentes una mayor inmersión y aplicación práctica de estas tecnologías.

En el ámbito legislativo, Nicaragua ha promovido leyes que favorecen la incorporación de la tecnología en el sistema educativo. La Ley General de Educación de 2006, modificada en 2014, establece como uno de los objetivos de la Educación Básica «desarrollar aprendizajes en los campos de las ciencias, las humanidades, la técnica, la cultura, el arte, la educación física y los deportes, así como aquellos que permitan el educando un buen uso y usufructo de las nuevas tecnologías» \parencite{unesco2023nicaragua}.

Asimismo, se han implementado políticas públicas para integrar las TIC en la educación. El Plan Nacional de Educación 2017-2021 contempla el uso de tecnologías educativas para mejorar el aprendizaje y propone que «la implementación del currículo actualizado, incluirá el uso de diferentes recursos tecnológicos de comunicación e información, así como la programación con fines educativos, para lo cual se organizará la formación de docentes». Adicionalmente, las rutas educativas buscan «promover el acceso y dominio de las tecnologías como herramientas para incentivar la innovación educativa, creatividad y curiosidad científica, a través del equipamiento de aulas de tecnologías, conectividad y el uso de software educativo y la capacitación y motivación de Estudiantes y docentes» \parencite{unesco2023nicaragua}.

Más recientemente, el Plan Nacional de Lucha contra la Pobreza y para el Desarrollo Humano 2022-2026 propone «impulsar el conocimiento y uso de la digitalización con todos(as) y para todos (as)». De igual manera, el Programa Nacional de Desarrollo Humano 2018-2021 planteó el desarrollo de políticas de TIC y el «fomento del buen uso de la tecnología educativa, para la creatividad, la innovación y el emprendimiento», incluyendo el aprovechamiento de diversas tecnologías para involucrar a la juventud en el desarrollo del país \parencite{unesco2023nicaragua}.
