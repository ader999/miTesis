...
\begin{table}[H]
    ...
    \caption{Aspectos más útiles del sistema (Pregunta de Selección Múltiple)}
    ...
    \begin{tablenotes}
        \footnotesize
        \item \textit{Nota.} Los porcentajes no suman 100\% debido a que los encuestados podían seleccionar múltiples opciones.
    \end{tablenotes}
    \end{threeparttable}
\end{table}
