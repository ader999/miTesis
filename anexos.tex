...
\begin{description}
    \item[Backend:] Parte del desarrollo web que se encarga de toda la lógica de una página que funciona en el servidor.
    ...
    \item[Digitalización:] Proceso de convertir información analógica en formato digital.
    \item[Diseño Mixto Secuencial Explicativo:] Diseño de investigación que implica una fase inicial de recolección y análisis de datos cuantitativos seguida de otra fase de recolección y análisis de datos cualitativos.
    \item[Django:] Framework de desarrollo web de alto nivel, escrito en Python, que fomenta un desarrollo rápido y un diseño limpio y pragmático.
    \item[Framework:] Estructura conceptual y tecnológica de soporte definida, normalmente con artefactos o módulos de software concretos, que puede servir de base para la organización y desarrollo de software.
    \item[Frontend:] Parte de un sitio web que interactúa con los usuarios.
    \item[Inteligencia Artificial Generativa (IAG):] Rama de la inteligencia artificial que se enfoca en la generación de contenido nuevo, como texto, imágenes, audio y video, a partir de datos existentes.
    \item[PLANEAUML:] Sistema web desarrollado para la digitalización y optimización de los planes de estudio en la Universidad Martín Lutero.
    \item[Plan de Estudio:] Esquema estructurado de las áreas obligatorias y fundamentales y de las áreas optativas con sus respectivas asignaturas que forman parte del currículo de los establecimientos educativos.
    \item[PostgreSQL:] Sistema de gestión de bases de datos relacional orientado a objetos y de código abierto.
    \item[Prompt:] Instrucción o texto inicial que se proporciona a una inteligencia artificial generativa para guiar su respuesta o creación.
    \item[Python:] Lenguaje de programación de alto nivel, interpretado y de propósito general.
    \item[Railway:] Plataforma de infraestructura como servicio (IaaS) que permite a los desarrolladores desplegar aplicaciones en la nube.
    \item[Sílabo:] Documento que contiene la información general de una asignatura, así como la programación de los contenidos y las actividades a desarrollar.
    \item[TAM (Technology Acceptance Model):] Teoría de sistemas de información que modela cómo los usuarios llegan a aceptar y utilizar una tecnología.
    \item[TIC (Tecnologías de la Información y Comunicación):] Conjunto de recursos, herramientas, equipos, programas informáticos, aplicaciones, redes y medios que permiten la compilación, procesamiento, almacenamiento, transmisión de información.
    \item[TPACK (Technological Pedagogical Content Knowledge):] Modelo que identifica los tipos de conocimiento que un docente necesita dominar para integrar las TIC de una forma eficaz en la enseñanza.
\end{description}

\clearpage
\subsection{Manual Técnico del Sistema PLANEAUML}
\label{anexo:manual_tecnico}

El Manual Técnico del sistema PLANEAUML, que incluye la documentación detallada de requisitos, arquitectura, diseño de base de datos, diccionario de datos y guía de instalación, se encuentra disponible como un documento anexo a esta tesis. Este manual proporciona la evidencia técnica del desarrollo de ingeniería realizado y sirve como guía para el mantenimiento y escalabilidad futura del sistema.

Además, se puede consultar la versión digital del manual en el siguiente enlace: \url{https://ajrepozitorio.codeader.com/post/13/}