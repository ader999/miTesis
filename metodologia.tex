...
\caption{\textit{Operacionalización de Variables}} \label{tab:operacionalizacion} \\
\hline
...
\hline
\endlastfoot
\multicolumn{3}{l}{\textbf{Variable Independiente}} \\
\addlinespace[0.5em]
Implementación del sistema web PLANEAUML & Intervención tecnológica consistente en la incorporación y uso de la plataforma web desarrollada, que integra módulos de gestión académica e IA generativa en los procesos de planificación. (Los detalles técnicos, arquitectura y manual de usuario se encuentran en el Manual Técnico en los Anexos). & - Uso de módulos de gestión.\newline - Uso de herramientas de IA. \\
\addlinespace[1em]
\multicolumn{3}{l}{\textbf{Variables Dependientes}} \\
\addlinespace[0.5em]
...
\addlinespace[1em]
\multicolumn{3}{l}{\textbf{Variable de Control}} \\
\addlinespace[0.5em]
