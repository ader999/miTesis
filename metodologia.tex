...
\paragraph{3. Triangulación de Datos} En coherencia con el diseño mixto de triangulación concurrente, se contrastaron los hallazgos obtenidos de las diferentes fuentes. Se compararon las narrativas de las entrevistas en profundidad con las respuestas breves de los cuestionarios abiertos y, a su vez, estos hallazgos cualitativos se cruzaron con los resultados estadísticos cuantitativos. Esta triangulación permitió validar la consistencia de la información y enriquecer la interpretación, asegurando que las tendencias numéricas (ej. reducción de tiempo) estuvieran respaldadas por explicaciones vivenciales (ej. sensación de alivio y reinversión pedagógica).
...
\paragraph{Credibilidad} Este criterio, análogo a la validez interna, se logró principalmente a través de la \textbf{triangulación de datos}. Como se describió en el diseño mixto, se contrastaron las perspectivas obtenidas de las entrevistas en profundidad con las respuestas de los cuestionarios abiertos y los datos cuantitativos, buscando convergencia y consistencia en los hallazgos. Además, se alcanzó la \textbf{saturación de categorías}, asegurando que la recolección de datos continuara hasta que no emergiera nueva información significativa, garantizando así una comprensión completa del fenómeno.
